...
const copyOnClick = () => {
  navigator.clipboard.writeText("martingranstrom@live.se");
};
...
function Icons() {
  return (
    <>
      <li>
        <a
          href="https://www.linkedin.com/in/martin-granström-33a1a5134/"
          target="_blank"
          rel="noreferrer"
        >
          <svg
      ...
      <li>
        <a
          href="https://github.com/martingranstrom"
          target="_blank"
          rel="noreferrer"
        >
          <svg
...
export function TopIcons(props) {
  return (
...
export function SideIcons(props) {
  return (
    <ul className={props.showIconRight ? "showIconRight" : "hideIconRight"}>
      <Icons />
    </ul>
  );
}
